...
<template>
    <div class="slug-widget">
      ...
      <div class="url-wrapper wrapper">
        ...
        ><input type="text" class="input is-small" name="slug" id="slug-editor" v-show="isEditing" v-model="customSlug" @keyup="adjustWidth" @keydown.esc.prevent @keydown.enter.prevent/>
      </div>
